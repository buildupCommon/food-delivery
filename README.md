...
넷플렉스 커버하기 - https://1sung.tistory.com/106

기능적 요구사항
1. 고객이 넷플렉스에서 구독한다
1. 고객이 결제한다
1. 결제가 완료되면 구독 내역이 관리팀에게 전달된다
1. 관리팀에서 확인하여 권한을 부여한다
1. 고객이 구독을 취소할 수 있다
1. 구독은 자동갱신된다
1. 자동갱신이 완료되면 카톡으로 알림을 보낸다

비기능적 요구사항
1. 트랜잭션
    1. 결제가 되지 않은 구독 건은 아예 거래가 성립되지 않아야 한다  Sync 호출 
